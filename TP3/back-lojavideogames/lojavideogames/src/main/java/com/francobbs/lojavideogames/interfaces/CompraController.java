...
public class CompraController {
    ...
    @GetMapping
    public List<Compra> listar() { return service.listar(); }
    ...
    public List<Compra> buscarPorUsuario(@PathVariable Long usuarioId) {
        return service.buscarPorUsuario(usuarioId);
    }

    @GetMapping("/periodo")
    public List<Compra> buscarPorPeriodo(@RequestParam LocalDateTime inicio,
                                         @RequestParam LocalDateTime fim) {
        return service.buscarPorPeriodo(inicio, fim);
    }

    @GetMapping("/valor/{valor}")
    public List<Compra> buscarPorValorMinimo(@PathVariable Double valor) {
        return service.buscarPorValorMinimo(valor);
    }
}